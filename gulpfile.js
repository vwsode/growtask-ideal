...
// Audio
const audio = require("gulp-audiosprite");
...
const path = {
    ...
    src: {
        ...
        js: srcPath + "*.js",
        imgaes: assetsPath + "img/**/*.{jpg,webp,png,svg,ico}",
    ...
    watch: {
        ...
        css: assetsPath + "scss/**/*.scss",
        js: srcPath + "**/*.js",
        images: assetsPath + "img/**/*.{jpg,webp,png,svg,ico}",
        fonts: assetsPath + "fonts/**/*.{woff,eot,woff2,ttf}",
    },
...
function fonts() {
    return src(path.src.fonts, { base: assetsPath + "fonts/" })
